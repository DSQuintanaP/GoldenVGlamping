...
namespace GoldenV.Controllers
{
    public class AbonoesController : Controller
    {
        ...
        public AbonoesController(GoldenVglampingContext context)
        {
            _context = context;
        }
        ...
        {
            var goldenVglampingContext = _context.Abonos.Include(a => a.IdReservaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdAbono,IdReserva,FechaAbono,CantAbono")] Abono abono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAbono,IdReserva,FechaAbono,CantAbono")] Abono abono)
        {
            if (id != abono.IdAbono)
            {
                return NotFound();
